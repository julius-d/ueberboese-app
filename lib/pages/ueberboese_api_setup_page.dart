...
class UeberboesApiSetupPage extends StatefulWidget {
  const UeberboesApiSetupPage({super.key});

  @override
  State<UeberboesApiSetupPage> createState() => _UeberboesApiSetupPageState();
}

class _UeberboesApiSetupPageState extends State<UeberboesApiSetupPage> {
  ...
  void _saveConfig() {
    ...
    final newConfig = appState.config.copyWith(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Überböse API Setup'),
      ),
      body: Center(
